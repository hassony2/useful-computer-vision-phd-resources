...
- [x] How to release code that is easy to understand and to reuse [https://github.com/hassony2/useful-computer-vision-phd-resources/blob/master/](Useful-resources-for-code-releases.md)
